## About me 🚀
I'm an offensive security engineer driven by curiosity and a deep passion for understanding how systems work — and how they fail. I specialize in exploring complex environments to identify weaknesses before adversaries do, approaching each challenge with a mindset that goes beyond the obvious.

Whether testing large-scale infrastructures, auditing modern web apps, or diving into obscure bugs, I focus on finding practical, real-world security issues. I enjoy breaking assumptions, pushing boundaries, and helping teams improve their defenses through clear, actionable insights.

## CVE Contributions 🧬
I actively contribute to the cybersecurity community by discovering and responsibly disclosing vulnerabilities.
...
Credentials that support my day-to-day work in offensive security.
...
View all on my [Credential Platform profile](https://credentials.offsec.com/profile/vemus/wallet).

## Articles ✍️  
I occasionally write about practical security topics based on real-world challenges.
